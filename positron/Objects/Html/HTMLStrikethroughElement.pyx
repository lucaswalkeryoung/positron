# -------------------------------------------------------------------------------------------------
# ----------------------- IMPLEMENTATION :: Html-Strikethrough Element Class ----------------------
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
cdef class HTMLStrikethroughElement(HTMLElement):
...
document.registerPrototype('html', 's', HTMLStrikethroughElement)