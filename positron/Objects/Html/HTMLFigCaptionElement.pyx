# -------------------------------------------------------------------------------------------------
# ---------------------- IMPLEMENTATION :: Html-Figure-Caption Element Class ----------------------
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
cdef class HTMLFigCaptionElement(HTMLElement):
...
document.registerPrototype('html', 'figcaption', HTMLFigCaptionElement)